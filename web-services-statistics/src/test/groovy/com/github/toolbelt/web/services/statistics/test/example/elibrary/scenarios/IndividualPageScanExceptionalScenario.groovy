...
/**
 * Represents a response for the {@code IndividualPageScan} resource that fails with an exception in middle of streaming.
 *
 * @author <a href="mailto:y.skopets@gmail.com">Yaroslav Skopets</a>
 */
@TupleConstructor
class IndividualPageScanExceptionalScenario implements RequestProcessingScenario, SampleOperationsCapable {
    ...
    void enact(HttpServletRequest req, HttpServletResponse resp) {
        ...
        resp.with {
            ...
            outputStream.write('Stub for the actual PNG contents' as byte[])
        }

        // then fail with an exception, e.g. because the client has aborted the request
